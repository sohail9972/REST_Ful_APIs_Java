...
import static testing.ReaptingActions.utils.FileNameConstants.PUT_API_REQUEST;
import static testing.ReaptingActions.utils.FileNameConstants.TOKEN_REQUEST_BODY;

public class putApiRequest {

    @Test
    public void  PostRequestUsingText() {
